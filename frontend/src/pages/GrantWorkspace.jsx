...
const GrantWorkspace = () => {
    ...
    const handleGenerateGrant = async () => {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:5000/api/grants/${actualGrantId}/generate-enhanced`, {
                method: 'POST',
                headers: {
    ...
    const handleDeleteDocument = async (documentId, filename) => {
        ...
        try {
            const response = await fetch(`http://localhost:5000/api/files/${documentId}`, {
                method: 'DELETE'
            })
    ...
    const handleDeleteAllDocuments = async () => {
        ...
        try {
            const actualGrantId = grantId.startsWith('new-') ? '1' : grantId
            const response = await fetch(`http://localhost:5000/api/grants/${actualGrantId}/documents`, {
                method: 'DELETE'
            })
